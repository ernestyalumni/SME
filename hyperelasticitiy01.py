...
mesh = BoxMesh(0.0,0.0,0.0,3.0,0.3,0.3,12,8,8)
V = VectorFunctionSpace(mesh, "Lagrange", 1)

# Mark boundary subdomians
left =  CompiledSubDomain("near(x[0], side) && on_boundary", side = 0.0)
right = CompiledSubDomain("near(x[0], side) && on_boundary", side = 3.0)
...
r = Expression(("scale*0.0",
                ...
                scale = 0.5, y0 = 0.5, z0 = 0.5, theta = pi/12)
...
B  = Constant((0.0, -2.0, 0.0))  # Body force per unit volume
